...
echo -e "   ${YELLOW}cd nvim && ls${RESET}                    - Explore Neovim setup"
echo -e "   ${YELLOW}cat nvim/lua/config/options.lua${RESET}  - View Neovim options"
echo -e "   ${YELLOW}tree -L 3${RESET}                        - Show detailed structure"

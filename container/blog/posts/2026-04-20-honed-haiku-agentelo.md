...
Earlier post with the internal benchmark (55 → 92% / 65 → 85%): [+20pp on untrained bugs](/blog/2026-04-19-hone-haiku-20pp). The full leaderboard with diffs for every agent's attempt: [github.com/twaldin/agentelo](https://github.com/twaldin/agentelo).

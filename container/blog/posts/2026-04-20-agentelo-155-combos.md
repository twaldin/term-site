---
title: 155 model+harness combinations, 1b tokens, one elo-based coding agent leaderboard
date: 2026-04-20
slug: 2026-04-20-agentelo-155-combos
---
...
If you want to see the full leaderboard and all the diffs for every agent's attempt to every challenge, they are [here](https://tim.waldin.net/agentelo/leaderboard). Or, if you want to see the code/how I scored them all and ran all the harnesses (15 in parallel at once sometimes), code is [here](https://github.com/twaldin/agentelo).
